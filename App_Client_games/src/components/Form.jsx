      ...
      >
        ...
        <input
          style={{
            ...
            marginRight: "auto",
            transition:
              "background-color 0.3s ease" /* Añadimos una transición para suavizar el cambio */,
          }}
          type="submit"
          value="Solicitar juegos"
          onMouseOver={(e) =>
            (e.target.style.backgroundColor = "#CCCCCC")
          } /* Cambia el color de fondo al pasar el mouse sobre el elemento */
          onMouseOut={(e) =>
            (e.target.style.backgroundColor = "white")
          } /* Vuelve a cambiar el color de fondo cuando el mouse deja el elemento */
        />
